...
class Lecture_model extends MY_Model{
   ...
   function getStudent($cls_id , $sub_id){
        return $this->db->from("students")
			->select("students.* , student_cls_pool.std_id")
           ->join("student_cls_pool", "student_cls_pool.cls_id = $cls_id ")
           ->join("student_cls_subject","student_cls_subject.sub_id = $sub_id and student_cls_subject.sld_cls_id = student_cls_pool.id","left")
