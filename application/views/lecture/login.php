                ...
                <tr>
                    <td>
                        <input onblur="clearText(this)" onfocus="clearText(this)" value="Email "
                               name="Lecture[email]" id="UserLogin_username" type="text"/></td>
                </tr>
                <tr>
                    <td><input onblur="clearText(this)" onfocus="clearText(this)" value="Password"
                               name="Lecture[password]" id="UserLogin_password" type="password"/></td>
                </tr>
                <tr>
                    <td id="pid"
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url(); ?>/index.php?r=user/recovery">Lost Password?</a>
                                    <div class="student_reg">
                                        <a href="<?=base_url(); ?>/index.php?r=onlineadmission/registration/index">Register now</a> 
                                     </div>
                                </td>
                            </tr>
                        </table>
