...
<head>
    ...
    <script src="assets/js/capslock.js"></script>
    <script src="assets/js/showpassword/jquery.showPassword.js"></script>
...
<div class="loginboxWrapper" style="position:relative;">
    <div class="lw_left">
        <div class="lw_logo"><img src="assets/img/logo-1.png" width="171" height="161"/></div>
    </div>
    <div class="lw_right">
        <h1>Login</h1>
        ...
        <div class="form">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <input onblur="clearText(this)" onfocus="clearText(this)" value="Username or Email "
