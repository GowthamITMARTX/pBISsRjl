                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <fieldset>
                                <legend><span>Create Subject</span>

                                    <div  class="site_nav" >
                                        <a href="<?= base_url() ?>">Dashboard</a>
                                        &raquo;<a href="<?= base_url() ?>sys/subject"> Subject </a>
                                        &raquo; create
                                    </div>
                                </legend>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="reg_subject_name">Subject Code</label>
                                            <input type="text" id="reg_subject_name" name="form[code]"
                                                   class="form-control"
                                                   data-parsley-required="true">
                                        </div>
                                        <div class="form-group">
                                            <label for="reg_subject_name">Subject Name</label>
                                            <input type="text" id="reg_subject_name" name="form[title]"
