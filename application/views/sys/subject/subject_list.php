...
<html>
<head>
    <title>subject List <?= date("d-m-Y") ?> </title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Subject List
                            <div class="site_nav" >
                                ...
                                <tbody>
                                    <?php foreach($records as $k => $row): ?>
                                        <tr>
                                            <td><?= $k+1 ?></td>
                                            <td> <?= $row->code ?> </td>
                                            <td> <a class="edit" href="#" data-type="text" data-pk="<?= $row->id ?>" data-name="title" data-title="Enter Subject Title"><?= $row->title ?></a> </td>
