                            ...
                            <form data-parsley-validate method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label for="reg_batch_code">Expenses Type </label>
                                            <select name="form[e_type]"  class="form-control"   data-parsley-required="true" >
                                                <option value="" > ---- select ----- </option>
                                                <?php foreach($expenses_type as $ex ): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="form[note]" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="reg_batch_name">Amount</label>
                                            <input type="text" id="reg_batch_name" name="form[amount]"
